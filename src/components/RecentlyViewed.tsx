...
const RecentlyViewed: React.FC<RecentlyViewedProps> = ({ currentProductId, formatPrice }) => {
  ...
  const { t, dir, getLocalized } = useLanguage();
  ...
  return (
    <section className="py-12 border-t border-white/5" dir={dir}>
              ...
              <div className="relative aspect-square overflow-hidden bg-black/20">
                ...
                {product.quantity === 0 && (
                  <div className="absolute inset-0 bg-black/60 flex items-center justify-center">
                    <span className="text-white text-xs font-bold">{t('product_out_of_stock')}</span>
                  </div>
                )}
              </div>
              <div className="p-3">
